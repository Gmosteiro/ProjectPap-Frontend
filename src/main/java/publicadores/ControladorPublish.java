...
public interface ControladorPublish extends java.rmi.Remote {
        ...
        public ArrayList<ActividadDeportiva> getActividadesByProfe(java.lang.String arg0)
                        throws java.rmi.RemoteException;
        ...
        public ArrayList<Usuario> getSociosByClase(publicadores.Clase arg0) throws java.rmi.RemoteException;
